...
const originalDestinationState = internalSigRead(0x28n);
const probeAddress = internalSigRead(0x10n);
internalSigWrite(0x28n, sourceSignatureState);
const expectedProbeValue = absRead64(probeAddress);
internalSigWrite(0x28n, originalDestinationState);
