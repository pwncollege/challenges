...
If a previous experiment left a file, directory, or symlink named `myflag` or `instructions` in your current directory, remove it first so the shell can create normal writable files there.
