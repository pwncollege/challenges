...
If a previous experiment left a file, directory, or symlink named `myflag` in your current directory, remove it first so the shell can create a normal writable file there.
