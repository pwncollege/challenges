...
However, we _do_ know that functional quantum computers can factor: Euler 2.0 (actually, [Peter Shor](https://en.wikipedia.org/wiki/Peter_Shor)) already came up with the [algorithm](https://en.wikipedia.org/wiki/Shor%27s_algorithm)!
